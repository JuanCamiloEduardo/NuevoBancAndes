...
public class GerenteOficina implements VOGerenteOficina{
	...
	public GerenteOficina(long id, String nombre, String login, String clave, long numeroDocumento,
			String tipoDocumento, String nacionalidad, String direccionFisica, String direccionElectronica,
			long telefono, String ciudad, String departamento, long codigoPostal) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.login = login;
	...
	public String toString() {
		return "GerenteOficina [id=" + id + ", nombre=" + nombre + ", login=" + login + ", clave=" + clave
